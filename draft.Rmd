...
# Гарик, тут что-то не то.. бабочка у нас комната
...
* the word *haq'u* 'butterfly' was attributed inanimate 1 class by older speakers four times, and by younger speakers five times, so its variability rate will be different in different groups: $$\frac{inanimate_1}{inanimate_1+inanimate_2} = \frac{4}{4+4} = 0.5$$
