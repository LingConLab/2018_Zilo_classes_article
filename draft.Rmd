...
```{r map, fig.width=6, fig.height=4.5, cashe = TRUE, fig.cap= "Figure 1. Andi on the map"}
...
```{r map, fig.width=6, fig.height=4.5, cashe = TRUE, fig.cap= "Figure 1. The Andi villages and their neighbours"}
...
map.feature(coord$Language,
            ...
            longitude = coord$Lon,
            width = 8,
            color = c("white", "deepskyblue", "darkseagreen", "aquamarine4", "aquamarine2", "lightblue1"),
            label = coord$label,
            label.hide = FALSE,
            label.fsize = 12,
            label.font = 'Brill',
